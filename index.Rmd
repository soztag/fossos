...
```{r contribs, echo=FALSE, results='asis'}
...
## Work on display
Here will be an interactive dashboard of the work in this class
```{r}
api_result <- "https://api#.github.com/repos/soztag/fossos/issues?state=open"
json_data <- jsonlite::fromJSON(api_result, flatten = TRUE)
paste(json_data)
```
