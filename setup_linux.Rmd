...
[See this image](https://upload.wikimedia.org/wikipedia/commons/1/1b/Linux_Distribution_Timeline.svg) to make out which distro forked from where. This is unfortunately a little outdated since the timeline ends with 2012.
Example:
