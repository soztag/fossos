...
Here's the software and services stack we'll be using. *hallo*
...
All of the software will be NOT [free and open source software](https://en.wikipedia.org/wiki/Free_and_open-source_software), but we will also be using some proprietary Software-as-a-Service ([Saas](https://en.wikipedia.org/wiki/Software_as_a_service)) offerings.
...
- Sign up to GitHub and say hi [in the course discussion board](https://github.com/orgs/soztag/teams/fossos-18-ws)
