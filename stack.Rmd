...
- Sign up to StackOverflow and post your profile to the [course discussion board](https://github.com/orgs/soztag/teams/fossos-18-ws)
- Find an interesting question an StackOverflow and post it to the [course discussion board](https://github.com/orgs/soztag/teams/fossos-18-ws)
- Sign up to RStudio community and post your profile to the [course discussion board](https://github.com/orgs/soztag/teams/fossos-18-ws)
- Find and interesting discussion on RStudio community and post it to the [course discussion board](https://github.com/orgs/soztag/teams/fossos-18-ws)
...
We are using it in this class to reduce the burden of local installations, but it is also generally a helpful tool.
...
- Install and run a docker image:
  ...
  3. Launch a system shell and type in
    ...
    ```
    docker run --edit PASSWORD=yourpassword --rm --publish=8787:8787 rocker/verse
    ```
...
- _Unpaywall_ [link](https://unpaywall.org/)

Finding the perfect article only to notice it is behind a paywall can be frustrating. Unpaywall is a browser extension that checks if the document can be obtained from a free and legal alternative source.
