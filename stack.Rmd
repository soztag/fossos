...
- *Do I have privileges to install software? If now, how can I get them?*
...
GitHub is a collaboration, code repository and git host (more on all of below) *along with some helpful project management tools*.
...
Remember to also configure [RStudio Cloud with your git credentials](https://maurolepore.github.io/cloudgithub/)
</div>
...
It *is* technically possible to use most, if not all, of the tools below on Windows, but they may behave slightly differently, and supporting them may be more involved.
...
5. By an x86 Chromebook and use [crouton](https://github.com/dnschneid/crouton) or (better, but still in beta?) [crostini](https://www.zdnet.com/article/how-to-add-linux-to-your-chromebook/) to run Linux on your Chromebook.
